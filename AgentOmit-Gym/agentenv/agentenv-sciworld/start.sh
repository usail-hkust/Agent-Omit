...
unset __conda_setup
port=$1
conda activate /nfs/ofs-llm-ssd/user/ningyansong/envs/agentenv-sciworld
# launch the server
cd /your_path_/agentenv-sciworld
sciworld --host 0.0.0.0 --port "$port" > "sciworld_${port}.log" 2>&1 &