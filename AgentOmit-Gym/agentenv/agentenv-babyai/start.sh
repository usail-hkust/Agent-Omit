...
unset __conda_setup
port=$1
conda activate /nfs/ofs-llm-ssd/user/ningyansong/envs/agentenv-babyai/
# launch the server
cd /nfs/ofs-llm-ssd/user/ningyansong/TODAgent/AgentOmit/AgentOmit-Gym/agentenv-babyai
/nfs/ofs-llm-ssd/user/oliverleo/miniconda3/bin/babyai --host 0.0.0.0 --port "$port" > "babyai_${port}.log" 2>&1 &