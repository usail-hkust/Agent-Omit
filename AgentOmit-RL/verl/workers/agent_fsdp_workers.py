...
class ActorRolloutRefWorker(Worker):
    ...
    def generate_sequences(self, prompts: DataProto):
        ...
        with self.rollout_sharding_manager:
            ...
            # print('======00000=======')
            # print(self.validation_mode)
            if self.validation_mode:
                self.rollout.validation_mode = True
            else:
                self.rollout.validation_mode = False
            if self.rollout_mode:
                self.rollout.rollout_mode = True
            else:
                self.rollout.rollout_mode = False
    ...
    @register(dispatch_mode=Dispatch.ONE_TO_ALL)
    def change_to_rollout_mode(self):
